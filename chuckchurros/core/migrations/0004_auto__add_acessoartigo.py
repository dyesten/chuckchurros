...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tb_acesso_artigos', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('artigos', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Artigos'])),
    ...
    def backwards(self, orm):
        ...
        #db.delete_table('tb_acesso_artigos')
		pass
    ...
    models = {
        ...
        u'core.acessoartigo': {
            'Meta': {'object_name': 'AcessoArtigo', 'db_table': "'tb_acesso_artigos'"},
            'artigos': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Artigos']"}),
            'dataAcesso': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'core.artigos': {
            'Meta': {'ordering': "['-dataCadastro']", 'object_name': 'Artigos', 'db_table': "'tb_artigos'"},
