...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contatos.telefone'
        db.alter_column('tb_contatos', 'telefone', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Contatos.telefone'
        db.alter_column('tb_contatos', 'telefone', self.gf('django.db.models.fields.CharField')(default=1, max_length=15))
