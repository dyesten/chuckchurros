...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'core', ['Artigos'])
        ...
        db.send_create_signal(u'core', ['Contatos'])


    def backwards(self, orm):
        # Deleting model 'Artigos'
        db.delete_table('tb_artigos')
